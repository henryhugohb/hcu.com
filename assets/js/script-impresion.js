...
function llenarCombo(tabla,campo1,param1,campo2,param2,combo)
{
	...
	xmlhttp.open("GET","llenarLugar.php?tabla="+tabla+'&campo_1='+campo1+'&param_1='+param1+'&campo_2='+campo2+'&param_2='+param2+'',true);
	xmlhttp.send();
